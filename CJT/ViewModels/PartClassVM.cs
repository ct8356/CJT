...
namespace CJT.ViewModels {
    public class PartClassVM : EntryVM {
        ...
        public PartClassVM(PartClass part, DbContext dbContext) {
            initialize(part, dbContext);
        }

        public PartClassVM(PartClass part, ITreeVM parentVM) {
            //NOTE: this constructor just WRAPS a student in a VM.
            initialize(part, parentVM, parentVM.DbContext);
        }

        public PartClassVM(String name, ITreeVM parentVM) {
